...
export class Members {
  members = [
    ...
    {pic: 'images/profile.jpg',name: 'Va Rayu', school: 'Setec institute', address: 'Kompot', contact: '0123456789', skill: 'binggner coding'},
    {pic: 'images/profile.jpg',name: 'Oeun Somun', school: 'Setec institute', address: 'Kompot', contact: '0123456789', skill: 'binggner coding'}
  ];
}
